...
const Profile: FC<ProfileProps> = () => {
    ...
    return (
        <>
            <div className={`${profileToggle ? 'translate-x-0' : 'translate-x-full'} bg-white transition-all duration-300  shadow-md  fixed right-0 max-[550px]:right-0 top-14 rounded w-72 max-[550px]:w-full h-auto flex flex-col gap-5 p-5 max-[550px]:p-10 font-semibold text-gray-800 z-40 `}>
